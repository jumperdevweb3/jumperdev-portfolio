    ...
    >
      <div className="flex animate-levitation flex-col items-center gap-6 md:min-h-[300px] md:min-w-[300px]">
        <Image
          ...
          className="duration-400 h-[300px] w-[300px] rounded-[50%] bg-avatar-gradient object-contain shadow-own-shadow shadow-pink transition-all hover:shadow-avatar-hover 2xl:h-[400px] 2xl:w-[400px] sm-mob:h-[250px] sm-mob:w-[250px] "
          width={300}
          height={300}
          alt="avatar image"
          priority
