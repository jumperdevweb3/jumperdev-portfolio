    ...
    <div ref={avatarRef} className="min-h-[400px] translate-x-full">
      <div className="flex animate-levitation flex-col gap-6">
        <Image
          ...
          className="duration-400 h-[300px] w-[300px] rounded-[50%] bg-avatar-gradient object-contain shadow-own-shadow shadow-pink transition-all hover:shadow-avatar-hover xl:h-[450px] xl:w-[450px]"
          width={300}
          height={300}
          alt="avatar image"
          priority
